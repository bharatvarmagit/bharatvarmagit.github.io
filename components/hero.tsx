...
function hero({skills}:skillType) {
  return (
    ...
    <div className="w-full h-full -mt-2 rounded-md flex md:items-center  md:justify-center overflow-hidden z-10">
        <Spotlight />


      <div className=" max-w-6xl  flex flex-col gap-4 mx-auto relative z-10  w-full pt-20 md:pt-0">
